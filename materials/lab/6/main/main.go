...
func main() {
    ...
    //router.HandleFunc("/addsearch/{regex}", scrape.TODOREPLACE).Methods("GET")
   // router.HandleFunc("/clear", scrape.TODOREPLACE).Methods("GET")
    //router.HandleFunc("/reset", scrape.TODOREPLACE).Methods("GET")
